...
#include "Configs/EngineConfigs.hpp"

namespace Neko::Core
{
    ThreadPool::ThreadPool() { initializePool(Enum::CPUThreadUsage::medium); }
    ...
    void ThreadPool::initializePool(Enum::CPUThreadUsage usageMode)
    {
