#ifndef HDG_CORE_THREADING_THREADPOOL_HPP
#define HDG_CORE_THREADING_THREADPOOL_HPP
...
namespace Neko::Core
{
    ...
    private:
        ...
        void initializePool(Enum::CPUThreadUsage usageMode);
...
#endif /* HDG_CORE_THREADING_THREADPOOL_HPP */